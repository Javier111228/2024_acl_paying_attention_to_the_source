...
from .logits_process import (
    ...
    ContrastiveAttentionLogitsProcessor,
)
...
class GenerationMixin:
    ...
    def _get_logits_processor(
        ...
        # add our contrastive attention decoding
        if generation_config.contrastive_decoding is True:
            processors.append(ContrastiveAttentionLogitsProcessor(contrastive_lambda=generation_config.contrastive_lambda))
    ...
    def greedy_search(
        ...
        **model_kwargs,
        ...
        while True:
            ...
            if len(next_tokens_scores.shape) > 3:
                next_tokens_scores = next_tokens_scores[0]
